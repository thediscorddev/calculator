...
void CalculatorMainActivity::PrepareKeyboard()
{
    ...
    FirstPageButton.push_back(std::make_shared<Button>(this, 1021, "x^2", wxPoint(0, 270), wxSize(100, 30)));
    ...
    FirstPageButton.push_back(std::make_shared<Button>(this, 1024, "sin", wxPoint(0, 240), wxSize(100, 30)));
    FirstPageButton.push_back(std::make_shared<Button>(this, 1025, "cos", wxPoint(100, 240), wxSize(100, 30)));
    FirstPageButton.push_back(std::make_shared<Button>(this, 1026, "tan", wxPoint(200, 240), wxSize(100, 30)));
    ...
    FirstPageButton.push_back(std::make_shared<Button>(this, 1030, "cot", wxPoint(300, 240), wxSize(100, 30)));
    FirstPageButton.push_back(std::make_shared<Button>(this, 1031, "sec", wxPoint(400, 240), wxSize(100, 30)));
    FirstPageButton.push_back(std::make_shared<Button>(this, 1032, "csc", wxPoint(500, 240), wxSize(100, 30)));
    FirstPageButton.push_back(std::make_shared<Button>(this, 1033, "ln", wxPoint(300, 270), wxSize(100, 30)));
    ...
    FirstPageButton.push_back(std::make_shared<SpecialButton>(this, 1064, "Si", wxPoint(600, 420), wxSize(100, 30)));
    FirstPageButton.push_back(std::make_shared<SpecialButton>(this, 1065, "Ci", wxPoint(700, 420), wxSize(100, 30)));
    ...
    FirstPageButton.push_back(std::make_shared<SpecialButton>(this, 1068, "Li", wxPoint(600, 360), wxSize(100, 30)));
