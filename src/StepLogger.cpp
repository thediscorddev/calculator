...
void StepLogger::Append(std::string Text, std::string latex, int level, bool display)
{
    if (display)
    {
...
void StepLogger::Append(std::string Text1, std::string Text2, std::string latex, int level, bool display)
{
    if (display)
    {
